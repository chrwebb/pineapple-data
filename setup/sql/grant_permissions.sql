...
ALTER FUNCTION data.asset_point_tiles_by_asset_id (z integer, x integer, y integer, in_asset_id integer) SECURITY DEFINER SET search_path = public;
ALTER FUNCTION data.sentinel_point_tiles_by_sentinel_id (z integer, x integer, y integer, in_sentinel_id integer) SECURITY DEFINER SET search_path = public;
...
GRANT EXECUTE ON FUNCTION data.asset_point_tiles_by_asset_id TO tileserver_user;
GRANT EXECUTE ON FUNCTION data.sentinel_point_tiles_by_sentinel_id TO tileserver_user;