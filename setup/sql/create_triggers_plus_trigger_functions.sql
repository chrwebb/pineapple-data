...
CREATE OR REPLACE FUNCTION data.fn_asset_insert_climate_normals() RETURNS trigger AS
  $BODY$
  BEGIN
    INSERT INTO data.climate_normals_1991_2020(
      ...
      (
      	SELECT
      	  CASE
      		WHEN (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt1 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean=Null THEN (SELECT ST_Value(rast, ST_Centroid(NEW.aoi_geom4326)) FROM data.climate_normals_ppt1 WHERE ST_Intersects(rast, NEW.aoi_geom4326))
      		ELSE (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt1 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean
      	  END
      )
    )
    ...
    INSERT INTO data.climate_normals_1991_2020(
      ...
      (
      	SELECT
      	  CASE
      		WHEN (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt2 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean=Null THEN (SELECT ST_Value(rast, ST_Centroid(NEW.aoi_geom4326)) FROM data.climate_normals_ppt2 WHERE ST_Intersects(rast, NEW.aoi_geom4326))
      		ELSE (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt2 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean
      	  END
      )
    )
    ON CONFLICT DO NOTHING;
    INSERT INTO data.climate_normals_1991_2020(
      ...
      (
      	SELECT
      	  CASE
      		WHEN (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt3 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean=Null THEN (SELECT ST_Value(rast, ST_Centroid(NEW.aoi_geom4326)) FROM data.climate_normals_ppt3 WHERE ST_Intersects(rast, NEW.aoi_geom4326))
      		ELSE (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt3 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean
      	  END
      )
    )
    ON CONFLICT DO NOTHING;
    INSERT INTO data.climate_normals_1991_2020(
      ...
      (
      	SELECT
      	  CASE
      		WHEN (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt4 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean=Null THEN (SELECT ST_Value(rast, ST_Centroid(NEW.aoi_geom4326)) FROM data.climate_normals_ppt4 WHERE ST_Intersects(rast, NEW.aoi_geom4326))
      		ELSE (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt4 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean
      	  END
      )
    )
    ON CONFLICT DO NOTHING;  
    INSERT INTO data.climate_normals_1991_2020(
      ...
      (
      	SELECT
      	  CASE
      		WHEN (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt5 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean=Null THEN (SELECT ST_Value(rast, ST_Centroid(NEW.aoi_geom4326)) FROM data.climate_normals_ppt5 WHERE ST_Intersects(rast, NEW.aoi_geom4326))
      		ELSE (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt5 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean
      	  END
      )
    )
    ON CONFLICT DO NOTHING;
    INSERT INTO data.climate_normals_1991_2020(
      ...
      (
      	SELECT
      	  CASE
      		WHEN (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt6 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean=Null THEN (SELECT ST_Value(rast, ST_Centroid(NEW.aoi_geom4326)) FROM data.climate_normals_ppt6 WHERE ST_Intersects(rast, NEW.aoi_geom4326))
      		ELSE (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt6 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean
      	  END
      )
    )
    ON CONFLICT DO NOTHING;
    INSERT INTO data.climate_normals_1991_2020(
      ...
      (
      	SELECT
      	  CASE
      		WHEN (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt7 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean=Null THEN (SELECT ST_Value(rast, ST_Centroid(NEW.aoi_geom4326)) FROM data.climate_normals_ppt7 WHERE ST_Intersects(rast, NEW.aoi_geom4326))
      		ELSE (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt7 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean
      	  END
      )
    )
    ON CONFLICT DO NOTHING;
    INSERT INTO data.climate_normals_1991_2020(
      ...
      (
      	SELECT
      	  CASE
      		WHEN (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt8 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean=Null THEN (SELECT ST_Value(rast, ST_Centroid(NEW.aoi_geom4326)) FROM data.climate_normals_ppt8 WHERE ST_Intersects(rast, NEW.aoi_geom4326))
      		ELSE (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt8 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean
      	  END
      )
    )
    ON CONFLICT DO NOTHING;
    INSERT INTO data.climate_normals_1991_2020(
      ...
      (
      	SELECT
      	  CASE
      		WHEN (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt9 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean=Null THEN (SELECT ST_Value(rast, ST_Centroid(NEW.aoi_geom4326)) FROM data.climate_normals_ppt9 WHERE ST_Intersects(rast, NEW.aoi_geom4326))
      		ELSE (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt9 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean
      	  END
      )
    )
    ON CONFLICT DO NOTHING;
    INSERT INTO data.climate_normals_1991_2020(
      ...
      (
      	SELECT
      	  CASE
      		WHEN (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt10 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean=Null THEN (SELECT ST_Value(rast, ST_Centroid(NEW.aoi_geom4326)) FROM data.climate_normals_ppt10 WHERE ST_Intersects(rast, NEW.aoi_geom4326))
      		ELSE (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt10 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean
      	  END
      )
    )
    ON CONFLICT DO NOTHING;
    INSERT INTO data.climate_normals_1991_2020(
      ...
      (
      	SELECT
      	  CASE
      		WHEN (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt11 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean=Null THEN (SELECT ST_Value(rast, ST_Centroid(NEW.aoi_geom4326)) FROM data.climate_normals_ppt11 WHERE ST_Intersects(rast, NEW.aoi_geom4326))
      		ELSE (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt11 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean
      	  END
      )
    )
    ON CONFLICT DO NOTHING;
    INSERT INTO data.climate_normals_1991_2020(
      ...
      (
      	SELECT
      	  CASE
      		WHEN (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt12 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean=Null THEN (SELECT ST_Value(rast, ST_Centroid(NEW.aoi_geom4326)) FROM data.climate_normals_ppt12 WHERE ST_Intersects(rast, NEW.aoi_geom4326))
      		ELSE (ST_SummaryStats(ST_Clip(ST_Union((SELECT ST_Union(rast) FROM data.climate_normals_ppt12 WHERE ST_Intersects(rast, NEW.aoi_geom4326))), NEW.aoi_geom4326))).mean
      	  END
      )
    )
    ON CONFLICT DO NOTHING;
...
CREATE TRIGGER sentinel_table_insert_timezone
  ...
  --INSERT asset table trigger for inserting to  data.climate_normals_1991_2020
DROP TRIGGER IF EXISTS asset_table_insert_climate_normals ON data.assets;
CREATE TRIGGER asset_table_insert_climate_normals
  AFTER INSERT ON data.assets
  FOR EACH ROW
  EXECUTE PROCEDURE data.fn_asset_insert_climate_normals();