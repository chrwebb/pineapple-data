...
raster2pgsql -d -C -s EPSG:4326 ./data/test/mp_aep_grid_10yr_all-season_mlc_bc_24h_ver1_4326.tif staging.pf_grids_10yr_24h | psql -h $PGHOST -d $PGDATABASE -U $PGUSER -p $PGPORT
raster2pgsql -d -C -s EPSG:4326 ./data/test/mp_aep_grid_20yr_all-season_mlc_bc_24h_ver1_4326.tif staging.pf_grids_20yr_24h | psql -h $PGHOST -d $PGDATABASE -U $PGUSER -p $PGPORT
raster2pgsql -d -C -s EPSG:4326 ./data/test/mp_aep_grid_50yr_all-season_mlc_bc_24h_ver1_4326.tif staging.pf_grids_50yr_24h | psql -h $PGHOST -d $PGDATABASE -U $PGUSER -p $PGPORT
raster2pgsql -d -C -s EPSG:4326 ./data/test/mp_aep_grid_100yr_all-season_mlc_bc_24h_ver1_4326.tif staging.pf_grids_100yr_24h | psql -h $PGHOST -d $PGDATABASE -U $PGUSER -p $PGPORT
raster2pgsql -d -C -s EPSG:4326 ./data/test/mp_aep_grid_10yr_all-season_mlc_bc_48h_ver1_4326.tif staging.pf_grids_10yr_48h | psql -h $PGHOST -d $PGDATABASE -U $PGUSER -p $PGPORT
raster2pgsql -d -C -s EPSG:4326 ./data/test/mp_aep_grid_20yr_all-season_mlc_bc_48h_ver1_4326.tif staging.pf_grids_20yr_48h | psql -h $PGHOST -d $PGDATABASE -U $PGUSER -p $PGPORT
raster2pgsql -d -C -s EPSG:4326 ./data/test/mp_aep_grid_50yr_all-season_mlc_bc_48h_ver1_4326.tif staging.pf_grids_50yr_48h | psql -h $PGHOST -d $PGDATABASE -U $PGUSER -p $PGPORT
raster2pgsql -d -C -s EPSG:4326 ./data/test/mp_aep_grid_100yr_all-season_mlc_bc_48h_ver1_4326.tif staging.pf_grids_100yr_48h | psql -h $PGHOST -d $PGDATABASE -U $PGUSER -p $PGPORT
