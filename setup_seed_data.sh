...
ogr2ogr -overwrite -f PostgreSQL PG:"host=$PGHOST user=$PGUSER dbname=$PGDATABASE" data/test/fwa_4326.geojson -dialect sqlite -nln data.freshwater_atlas -sql "select Geometry as geom4326 from fwa_4326"
